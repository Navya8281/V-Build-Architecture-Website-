              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    <span class="sectionHeading__subtitle text-white">REGISTRATION FORM</span>
                    <h2 class="sectionHeading__title text-white">Register Now</h2>

                    <form class="-light row js-ajax-form" action="authorityaction.php" method="POST">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="authorityname" data-required placeholder="Authority Name">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" data-required placeholder=" Email">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
