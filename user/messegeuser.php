...
<?php
 $results = $con->query("select * from message WHERE l_id=$l_id AND a_id=$cl_id");
    ...
    float:left;
    ">
                      <span  style="float:left;"><?php  echo $replay= $rows['replay']; ?></span>
    ...
    ">
     <?php
                      ...
                      if($rows['ur_img']!="") { ?>
                     <span  style="float:left; text-align: right;"><img width="200px" src="../uploads/<?php  echo $ur_img= $rows['ur_img']; ?>"> </span>
                   <?php } ?>
                     
                    <span  style="float:right; text-align: right;"><?php  echo $message= $rows['message']; ?> </span>
                    </div>
                    <div style="    
    justify-content: space-between;
    width: 100%;
    ...
    ">
                     <?php
                      ...
                      if($rows['u_img']!="") { ?>
                     <span  style="float:right; text-align: right;"><img width="200px" src="../uploads/<?php  echo $u_img= $rows['u_img']; ?>"> </span>
...
<input type="hidden" name="l_id" value="<?php echo $l_id; ?>" >
                      <input type="hidden" name="cl_id" value="<?php echo $cl_id; ?>" >
                       <input type="file" name="u_file"  style="border: 0;
    font-size: 0.875rem;
    line-height: 1.3;
    font-weight: 400;
    width: 50%;
