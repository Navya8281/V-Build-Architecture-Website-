              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">USER DETAILS</div>
                    <h1 class="page-masthead__title text-white">USER DETAILS</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">USER DETAILS</a>
                  </div>
                </div> -->
              </div>
            </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  ...
                  $result = $con->query("select * from userregistration WHERE ul_id='$l_id'");
                    ...
                    <form class="" action="uprofileupdate.php" method="POST">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="fname" value="<?php echo $row['u_fname'];?>" data-required placeholder="First Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="lname" value="<?php echo $row['u_lname'];?>" data-required placeholder="Last Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="js-input-group">
                          <textarea name="address" rows="5" placeholder="Address"><?php echo $row['u_address'];?></textarea>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" value="<?php echo $row['u_email'];?>" data-required placeholder=" Email">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="password" value="<?php echo $row['u_password'];?>" placeholder="Password">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="phonenumber" value="<?php echo $row['u_phonenumber'];?>" placeholder="phone Number">
