              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    <div class="page-masthead__subtitle">Lands For Sale</div>
                    <div class="page-masthead__back_title">Real Estate</div>
                    <h1 class="page-masthead__title text-white">Real Estate</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Real Estate</a>
                  </div>
                </div> -->
              </div>
            </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="../uploads/<?php echo $row['l_image'];?>" alt="Product image">

                        <a href="real_single.php?rl_id=<?php echo $row['rl_id'];?>&cccid=<?php echo $row['rl_id'];?>" class="shopCard__button">
                          <i class="icon" data-feather="shopping-bag"></i>
                          <?php  $rl_id= $row['rl_id'];
$result1 = $con->query("select * from real_estate_registration WHERE rl_id=$rl_id ");
