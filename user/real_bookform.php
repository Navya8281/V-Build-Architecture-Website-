            ...
            <div class="page-masthead__content">
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">BOOKING</div>
                    <h1 class="page-masthead__title text-white">BOOKING</h1>
                  </div>
                </div>
             ...
             <!--    <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Booking </a>
                  </div>
                </div> -->
              </div>
            </div>
          ...
          <div class="container">
            <div class="row no-gutters">
              <div class="col-xl-7 col-lg-7 z-1">
                <?php
                 $result = $con->query("select * from real_estate_registration WHERE r_id=$r_id");
 ...
 <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  <div class="sectionHeading -left-line">
                    <span class="sectionHeading__subtitle">BOOKING</span>
                    <h2 class="sectionHeading__title">BOOKING</h2>
                  </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    <span class="sectionHeading__subtitle text-white">Details</span>
                    <h2 class="sectionHeading__title text-white">Book Now</h2>

                    <form  action="bookingsucess.php" method="POST">
                     
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          
                          <input type="hidden" name="c_id" value="<?php echo $r_id;?>" data-required placeholder="first Name">
                          <input type="hidden" name="l_id" value="<?php echo $l_id;?>" data-required placeholder="first Name">
                          
                          <input type="text" name="f_name" value="<?php echo $u_name;?>" data-required placeholder="first Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="l_name" value="<?php echo $u_lname;?>" data-required placeholder="Last Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="js-input-group">
                          <textarea name="address"  rows="5" placeholder="Address"><?php echo $u_address;?></textarea>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" value="<?php echo $u_email;?>" data-required placeholder=" Email">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="contactnumber" value="<?php echo $u_phonenumber;?>" placeholder="Contact Number">
                           <span class="form__error"></span>
                        </div>
                      </div>
