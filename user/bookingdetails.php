              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Company Booking Details</div>
                    <h1 class="page-masthead__title text-white">Company Booking Details</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <!-- <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Company Booking Details</a>
                  </div> -->
                </div>
              </div>
            </div>
              ...
              <div class="col-lg">
                ...
                <div class="shopCart-products">
                  <?php
                    ...
                    $result = $con->query("SELECT company_registration.cl_id,company_registration.c_companyname,company_booking.b_date,company_booking.b_status,company_registration.c_file,company_booking.b_id  FROM company_booking INNER JOIN company_registration ON company_booking.bcl_id=company_registration.c_id WHERE company_booking.bl_id=$l_id");
                        ...
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__subtotal text-grey">
                            ...
                            $bbbbb= $row['b_id'];
                             ...
                             $results = $con->query("select * from requirement WHERE b_id=$bbbbb AND status='Approved'");
                               while($rows= mysqli_fetch_array($results))
                                 {
                    $plan= $rows['plan'];
                   }
                   ?>
                   <!-- <img src="../uploads/<?php echo  $plan; ?>"> -->
                   <?php 
                   if(isset($plan))
                   {
                   ?>
                   <a href="../uploads/<?php echo  $plan; ?>" download>
    <img src="../uploads/<?php echo  $plan; ?>" style="width: 100px;" />
 </a>
 <?php } ?>
      
                      <!--  <a href="deletebooking.php?b_id=<?php echo $row['b_id']; ?>"> view image</a> -->
                      </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__subtotal text-grey">
                            <div class="shopCart-products__cross">
                       <a href="rating.php?cl_id=<?php echo  $cl_id=$row['cl_id']; ?>"><input type="button" name="" value="Rating"> </a>
                      </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__subtotal text-grey">
                            <div class="shopCart-products__cross">
                       <a href="messegeuser.php?cl_id=<?php echo  $cl_id=$row['cl_id']; ?>"> <input type="button" name="" value="CHAT"></a>
                      </div>
                          </div>
                        </div>
                      </div>
