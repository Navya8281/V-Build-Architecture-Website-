...
error_reporting(0);
 $l_id;
 $ghfh="select * from userregistration WHERE ul_id=$l_id ";
 $results = $con->query($ghfh);
                               while($rows= mysqli_fetch_array($results))
                                 {
                                     $u_pincode= $rows['u_pincode']; }
?>
              ...
              <div class="col-12">
                <div class="d-flex justify-content-between">
                  ...
                  <div style="height: 100px; width: 300px; float: left; ">
                    <select name="pinn" style="color: black;">
                  ...
                  <div style="height: 100px; width: 300px; float: left;  margin-left: 50px; margin-top: 10px; "> <input type="submit" name="submit"></div>
...
$mmm=$u_pincode-$pinn;
$www=$u_pincode+$pinn;
 $sqllll="SELECT * FROM `company_registration` WHERE `pincode` BETWEEN '$mmm' AND '$www'";
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        ...
                        <a href="company_single.php?c_id=<?php echo $row['c_id'];?>&cccid=<?php echo $row['cl_id'];?>" class="shopCard__button">
