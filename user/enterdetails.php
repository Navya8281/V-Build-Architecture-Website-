              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">REQUIREMENTS</div>
                    <h1 class="page-masthead__title text-white">REQUIREMENTS</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Requirments </a>
                  </div>
                </div> -->
              </div>
            </div>
 ...
 <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  <div class="sectionHeading -left-line">
                    <span class="sectionHeading__subtitle">Requirments</span>
                    <h2 class="sectionHeading__title">Requirments</h2>
                  </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    ...
                    <h2 class="sectionHeading__title text-white">Requirements Now</h2>

                    <form  action="reqsucess.php" method="POST">
                     
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          
                          <input type="hidden" name="b_id" value="<?php echo $b_id;?>" data-required placeholder="first Name">
                             
                          <input type="checkbox" name="chk" value="Yes" >
                          <label>plan</label><br>
                          <input type="text" name="budget"  data-required placeholder="Budget">
                          
                         
                          
                          <input type="text" name="requirement"  data-required placeholder="Requirements">
