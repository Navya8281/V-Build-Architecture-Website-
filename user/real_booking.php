          ...
          <div class="container">
            <div class="row no-gutters">
              <div class="col-xl-7 col-lg-7 z-1">
                <!-- <?php
                 $result = $con->query("select * from userregistration WHERE ul_id=$l_id");
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    ...
                    <form  action="realbook_success.php" method="POST">
                     
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          
                          <input type="hidden" name="rl_id" value="<?php echo $rl_id;?>" data-required placeholder="first Name">
