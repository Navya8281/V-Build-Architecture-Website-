              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    <div class="page-masthead__subtitle">company</div>
                    <div class="page-masthead__back_title">Company Booking</div>
                    <h1 class="page-masthead__title text-white">Company Booking</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Company Booking</a>
                  </div>
                </div> -->
              </div>
            </div>
                  ...
                  <div class="socialsSection mt-24">
                   <div class="col-auto">
                    <form action="booking_form.php" method="post">
                      <input type="hidden" name="booking_id" value="<?php echo $row['c_id'];?>">
