          ...
          <div class="container">
            <div class="row no-gutters">
              <div class="col-xl-7 col-lg-7 z-1">
                <?php
                 $result = $con->query("select * from company_registration WHERE c_id=$c_id");
                    ...
                    <form  action="bookingsucess.php" method="POST">
                       ...
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          ...
                          <input type="hidden" name="c_id" value="<?php echo $c_id;?>" data-required placeholder="first Name">
