...
<!-- Mirrored from creativelayers.net/themes/hellix-html/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:13:40 GMT -->
<head>
...
<body class="preloader-visible" data-barba="wrapper">
  ...
  bg-black pattern_bg_2
">


      <div class="topbar bg-beige-dark md:d-none">
        <div class="container">
            ...
            <div class="col-auto">
              <div class="topbar__info">
                ...
                <div class="topbar__item">
                  <i class="topbar__icon text-white icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-white">+(123) 1234-567-8901</a>
                </div>

                <div class="topbar__item">
                  <i class="topbar__icon text-white icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-white">hello@hellix.com</a>
                </div>

                <div class="topbar__item">
                  <i class="topbar__icon text-white icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-white">Mon - Sat 8:00 - 17:30, Sunday - CLOSED</a>
                </div>
      ...
      <!-- header start -->
      <header class="header -home-2 -no-pad js-header">
