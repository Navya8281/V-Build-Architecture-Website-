              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                ...
                <div class="col-auto">
                  <!-- <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Architecture Companies</a>
                  </div> -->
                </div>
              </div>
            </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="uploads/<?php echo $row['c_file'];?>" alt="Product image">

                        <a href="user/company_single.php?c_id=<?php echo $row['c_id'];?>&cccid=<?php echo $row['cl_id'];?>" class="shopCard__button">
                      ...
                      <div class="shopCard__content mt-20">
                        <?php  $ccl_id= $row['cl_id'];?>
                        <h4 class="shopCard__title text-base mt-8"><?php echo $row['c_companyname'];?></h4>
                        <p>
                  <?php 
                  $countt='';
                  $counttt='';
                            $result1 = $con->query("select * from rating WHERE cl_id=$ccl_id");
                           $counttt= mysqli_num_rows($result1);
...
<span class="fa fa-star checked"></span>
  <?php
                     ...
                     <a href="reviewview.php?cl_id=<?php echo $ccl_id; ?>"> <button>Review</button>  </p></a>
                      </div>
                    </div>
                  </div>
