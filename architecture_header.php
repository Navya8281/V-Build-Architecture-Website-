...
<!-- Mirrored from creativelayers.net/themes/hellix-html/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:13:56 GMT -->
<head>
...
<body class="preloader-visible" data-barba="wrapper">
 ...
 ">
      ...
      <div class="topbar bg-white md:d-none">
            ...
            <div class="col-auto">
              <div class="topbar__info">
                ...
                <div class="topbar__item">
                  <i class="topbar__icon text-black icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-black">+(123) 1234-567-8901</a>
                </div>

                <div class="topbar__item">
                  <i class="topbar__icon text-black icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-black">hello@hellix.com</a>
                </div>

                <div class="topbar__item">
                  <i class="topbar__icon text-black icon-rocket"></i>
                  <a data-barba href="#" class="topbar__text text-black">Mon - Sat 8:00 - 17:30, Sunday - CLOSED</a>
                </div>
            ...
            <div class="col-auto">
              <div class="topbar__socials">
                <div class="topbar__socials_content">
                  <a data-barba href="#" class="text-black">
      ...
      <header class="header -home-3  -sticky-dark js-header">
        <div class="header__bar bg-white js-header-bar">
                ...
                <div class="menu js-menu ">
                  ...
                  <div class="menu__container">
                    ...
                    <ul class="nav js-navList ">
                      <li class="text-black menu-item-has-children">
                        <a data-barba href="#">Home</a>
                      ...
                      <li class="text-black -has-mega-menu menu-item-has-children">
            ...
            <div class="col-auto sm:pos-unset js-header-item">
              <div class="header__icons -separate">
                <div class="header__cart">
                  <a data-barba href="#">
                    <i class="icon text-black icon-cart"></i>
                  </a>
                ...
                <div class="header__search">
                  <button class="js-headerSearch-open">
                    <i class="icon text-black icon-search"></i>
                  </button>
                </div>
          ...
          <div class="headerSearch js-headerSearch">
            ...
            <button class="headerSearch__close js-headerSearch-close">
              <i class="icon icon-cross text-black"></i>
            </button>
          </div>
        </div>
