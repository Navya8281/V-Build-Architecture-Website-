...
<!-- Mirrored from creativelayers.net/themes/hellix-html/services-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:14:36 GMT -->
<head>
            ...
            <div class="menu js-menu ">
              ...
              <div class="menu__container">
               ...
               <ul class="nav js-navList ">
                    ...
                    <ul class="nav__submenu md:d-block d-none">
                      ...
                      <li class="nav__submenu_item menu-item-has-children">
                        ...
                        <ul class="nav__submenu md:d-block d-none">
                          ...
                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Two Columns</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Three Columns</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Three Columns Wide</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Four Columns</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Four Columns Wide</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Five Columns Wide</a>
                          </li>
                      ...
                      <li class="nav__submenu_item menu-item-has-children">
                        ...
                        <ul class="nav__submenu md:d-block d-none">
                          ...
                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Zoom</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Float</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Slide From Bottom</a>
                          </li>

                          <li class="nav__submenu_item">
                            <a data-barba href="#.html">Slide From Right</a>
                          </li>
                  ...
                  <li class="text-white menu-item-has-children">
                    <a data-barba href="feedback.php">Feedback</a>
                  ...
                  <li class="text-white menu-item-has-children">
                    <a data-barba href="login.php">Login</a>
                    ...
                    <div class="headerCart__content">
                      ...
                      <div class="headerCart__item">
                        <div class="headerCart__img">
                          <img src="img/main-sidebar/cart/1.jpg" alt="image">
                        </div>
                      ...
                      <div class="headerCart__item">
                        <div class="headerCart__img">
                          <img src="img/main-sidebar/cart/2.jpg" alt="image">
                        </div>
      ...
      <div class="content-wrapper  js-content-wrapper">
              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Services</div>
                    <h1 class="page-masthead__title text-white">Services</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Services</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="layout-pt-md layout-pb-md">
          <div class="container">
            ...
            <div class="tabs -section js-tabs">
              <div class="row y-gap-48">
                <div class="col-xl-3 col-lg-4">
                  <div class="tabs__controls js-tabs-controls">
                    <button class="tabs__button col-12 is-active" data-tab-target=".-tab-item-1" type="button">
                      <i class="icon text-xl text-accent icon-pencil mr-16"></i>
                      Architecture & Interior
                    </button>

                    <button class="tabs__button col-12 mt-20" data-tab-target=".-tab-item-2" type="button">
                      <i class="icon text-xl text-accent icon-rocket mr-16"></i>
                      Project Planning
                    </button>

                    <button class="tabs__button col-12 mt-20" data-tab-target=".-tab-item-3" type="button">
                      <i class="icon text-xl text-accent icon-cube mr-16"></i>
                      Product Design
                    </button>

                    <button class="tabs__button col-12 mt-20" data-tab-target=".-tab-item-4" type="button">
                      <i class="icon text-xl text-accent icon-idea mr-16"></i>
                      Custom Solutions
                    </button>
                  </div>
                </div>
                ...
                <div class="col-xl-9 col-lg-8">
                  <div class="tabs__content js-tabs-content">
                    <div class="tabs__pane -tab-item-1 is-active">
                      <div class="text-sm text-accent uppercase">WE OFFER</div>
                      <h4 class="text-2xl fw-600 mt-8">Custom Interior Design</h4>
                      <p class="mt-20">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                      <p class="mt-16">True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric covering, visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design and the savoir-faire associated with fine tailoring that have always distinguished the Minotti brand.</p>

                      <div class="row y-gap-32 py-48 md:py-32">
                        <div class="col-md-6">
                          <div class="ratio ratio-1:1 bg-image js-lazy" data-bg="img/blog/1.html"></div>
                        </div>
                        <div class="col-md-6">
                          <div class="ratio ratio-1:1 bg-image js-lazy" data-bg="img/blog/1.html"></div>
                        </div>
                    ...
                    <div class="tabs__pane -tab-item-3">
                      <div class="text-sm text-accent uppercase">WE OFFER</div>
                      <h4 class="text-2xl fw-600 mt-8">Product Design</h4>
                      <p class="mt-20">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                      <p class="mt-16">True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric covering, visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design and the savoir-faire associated with fine tailoring that have always distinguished the Minotti brand.</p>
                    </div>
                    ...
                    <div class="tabs__pane -tab-item-4">
                      <div class="text-sm text-accent uppercase">WE OFFER</div>
                      <h4 class="text-2xl fw-600 mt-8">Custom Solutions</h4>
                      <p class="mt-20">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                      <p class="mt-16">True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric covering, visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design and the savoir-faire associated with fine tailoring that have always distinguished the Minotti brand.</p>
                    </div>
                  </div>
...
<!-- Mirrored from creativelayers.net/themes/hellix-html/services-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:14:37 GMT -->
</html>