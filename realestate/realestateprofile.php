              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    <div class="page-masthead__subtitle">Explore the featurE</div>
                    <div class="page-masthead__back_title">REAL ESTATE DETAILS</div>
                    <h1 class="page-masthead__title text-white">REAL ESTATE DETAILS</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">REAL ESTATE DETAILS</a>
                  </div>
                </div> -->
              </div>
            </div>
              ...
              <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  <div class="sectionHeading -left-line">
                    <span class="sectionHeading__subtitle">REAL ESTATE DETAILS</span>
                    <h2 class="sectionHeading__title">REAL ESTATE DETAILS</h2>
                  </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                      ...
                      <?php 
                  $result = $con->query("select * from real_estate_registration WHERE rl_id=$l_id");
                               while($row= mysqli_fetch_array($result))
                                 {
                                 ?>

                    <form class="" action="rprofileupdate.php" method="POST">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="fname" value="<?php echo $row['r_fname'];?>" data-required placeholder="First Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="lname" value="<?php echo $row['r_lname'];?>" data-required placeholder="Last Name">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="js-input-group">
                          <textarea name="address" rows="5" placeholder="Address"><?php echo $row['r_address'];?></textarea>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" value="<?php echo $row['r_email'];?>" data-required placeholder=" Email">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="password" value="<?php echo $row['r_password'];?>" placeholder="Password">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="mobilenumber" value="<?php echo $row['r_mobilenumber'];?>" placeholder="Mobile Number">
                           <span class="form__error"></span>
                        </div>
                      </div>
