              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    <div class="page-masthead__subtitle">Upload</div>
                    <div class="page-masthead__back_title">Land Details</div>
                    <h1 class="page-masthead__title text-white">Land Details</h1>
                  </div>
                </div>
               ...
               <!--  <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Land Details</a>
                  </div>
                </div> -->
              </div>
            </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    <span class="sectionHeading__subtitle text-white">Lands For Sale</span>
                    <h2 class="sectionHeading__title text-white">Land Details</h2>

                    <form class="" action="land_action.php" method="POST" enctype="multipart/form-data">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="title" data-required placeholder="Title">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="landprice" data-required placeholder="Landprice">
                          <span class="form__error"></span>
                        </div>
                      </div>
