...
session_start();
 $l_id=$_SESSION['l_id'];
                  $results = $con->query("select * from real_estate_registration WHERE rl_id=$l_id");
                               while($rows= mysqli_fetch_array($results))
                                 {
									 $r_fname= $rows['r_fname'];
                   $r_id= $rows['r_id'];
								 }
                                 ?>
              ...
              <div class="menu__container">
                ...
                <ul class="nav js-navList ">
                  <li class="text-white menu-item-has-children">
                    <a data-barba href="realestateprofile.php">Profile</a>

                    
                  </li>
                  
                  <li class="text-white ">
                   <a data-barba href="real_upload.php">Land</a>


                    
                  </li>
                   <li class="text-white ">
                   <a data-barba href="realbooking.php">Bookings</a>
