...
<?php
 $ghfh="select * from real_message WHERE l_id=$rl_id AND r_id=$l_id";
 $results = $con->query($ghfh);
    ...
    float:left;
    ">
                      <span  style="float:right;"><?php  echo $replay= $rows['rm_replay']; ?></span>
    ...
    ">
                    ...
                    <span  style="float:left; text-align:right;"><?php  echo $message= $rows['rm_message']; ?> </span>
                    </div>
<?php  }
                   ?>


                 <form action="realmsgsubmit.php" method="POST"> 
...
<input type="hidden" name="l_id" value="<?php echo $l_id; ?>" >
                      <input type="hidden" name="rl_id" value="<?php echo $rl_id; ?>" >
