            ...
            <div class="row x-gap-60">
              <div class="col-lg">
                ...
                <div class="shopCart-products">
                  <?php
 $sql="SELECT *  FROM real_booking WHERE rerl_id=$l_id";
                    ...
                    <div class="row no-gutters y-gap-10 justify-content-between">
                      ...
                      <div class="col-md-4">
                        <div class="shopCart-products__product">
                         <!--  <div class="image">
                            <div class="bg-image js-lazy" data-bg="../uploads/<?php echo  $re_file= $row['re_file']; ?>"></div>
                          </div> -->
                          <div class="title"><?php echo  $re_fname= $row['re_fname']; ?></div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__quantity text-grey">
                            <?php echo  $re_status=$row['re_status']; ?>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__quantity text-grey">
                          <a href="realmessageuser.php?rl_id=<?php echo  $rel_id=$row['rel_id']; ?>">  view</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-2">
...
$dddd="Booked";
                               ...
                               {
                                ?>
                       <a href="real_acceptreg.php?re_id=<?php echo $row['re_id']; ?>"> Click to Accept</a>
                     <?php  } 
                     else
                     {
                      ?>
