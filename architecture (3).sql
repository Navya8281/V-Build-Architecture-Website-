...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 16, 2023 at 04:08 AM
...
INSERT INTO `message` (`m_id`, `l_id`, `message`, `replay`, `a_id`) VALUES
(1, 8, 'dsgdfhg', '0', 11),
(2, 8, 'dsgdfhg', '0', 11),
(3, 8, 'dvfgfdhbhgfn ', NULL, 15),
(4, 8, 'haii', NULL, 11),
(5, 8, 'hw r u', NULL, 11),
(6, 26, 'haiii', NULL, 19),
(9, 26, NULL, 'hw r u', 19),
(10, 26, 'i am fine', NULL, 19);
...
(6, 26, 'arya', 'sree', 'Kunnnathaattil(h),thekkumuri(p.o),eramankalam,kochi', 'arya@gmail.com', 'arya', '9426451378', 'uu.jpg');
COMMIT;
