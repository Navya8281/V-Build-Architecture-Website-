...
ON budget_booking.bbl_id = userregistration.ul_id WHERE budget_booking.bbcl_id=$l_id";
                      ...
                      <div class="col-md-4">
                        <div class="shopCart-products__product">
                         <!--  <div class="image">
                          ...
                          <div class="title"><?php echo  $u_fname= $row['u_fname']; ?></div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="d-flex h-100 align-items-center">
                          ...
                          <div class="shopCart-products__quantity text-grey">
                            <?php echo  $bb_status=$row['bb_status']; ?>
                          </div>
                        </div>
                      </div>
...
$dddd="Booked";
                               ...
                               {
                                ?>
                       <a href="budaccept.php?bb_id=<?php echo $row['bb_id']; ?>"> Click to Accept</a>
                     <?php  } 
                     else
                     {
                      ?>
