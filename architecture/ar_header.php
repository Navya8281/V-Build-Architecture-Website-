...
$l_id=$_SESSION['l_id'];
 include'../database.php';
                  $results = $con->query("select * from company_registration WHERE cl_id=$l_id");
                               while($rows= mysqli_fetch_array($results))
                                 {
									 $c_companyname= $rows['c_companyname'];
                   $c_id= $rows['c_id'];
								 }
                                 ?>
            ...
            <div class="menu js-menu ">
              ...
              <div class="menu__container">
                ...
                <ul class="nav js-navList ">
                  <li class="text-white">
                    <a data-barba href="architectureprofile.php">Profile</a>

                    
                  </li>
                    <li class="text-white">
                    <a data-barba href="gallery.php">Gallery</a>

                    
                  </li>
                  
                   <li class="text-white menu-item-has-children">
                    <a data-barba href="#">Bookings</a>

                    <ul class="nav__submenu">
                      <li class="nav__submenu_item">
                        <a data-barba href="booking.php">Normal Bookings</a>
                      </li>

                      <li class="nav__submenu_item">
                        <a data-barba href="budbook_view.php">Buget booking</a>
                      </li>
...
<!--
                  <li class="text-white ">
                    <a data-barba href="booking.php">Bookings</a>

                    
                  </li>
-->
                  <!-- <li class="text-white ">
                    <a data-barba href="reqview.php">Rrequirements</a>

                    
                  </li> -->
                   <li class="text-white ">
                    <a data-barba href="budgeted_home.php">Budgeted Homes</a>

                    
                  </li>
                   <li class="text-white">
                        <a data-barba href="logout.php">Logout</a>
                      </li>
<!--
                   <li class="text-white ">
                    <a data-barba href="budbook_view.php">Buget booking</a>
...
-->
                       ...
                       <li class="text-white menu-item-has-children">
<!--                    <a data-barba href="#">message</a>-->

                    <ul class="nav__submenu">
                      <?php
                       $results = $con->query("select * from message WHERE a_id=$l_id");
                               while($rows= mysqli_fetch_array($results))
                                 {
                                  ?>
                      ...
                      <li class="nav__submenu_item">
                        <a data-barba href="messageuser.php?al_id=<?php   echo $ll_id= $rows['l_id']; ?>"><?php    $ll_id= $rows['l_id'];

                         $results1 = $con->query("select * from userregistration WHERE ul_id=$ll_id");
                               while($rows1= mysqli_fetch_array($results1))
                                 {
                  echo  $u_fname= $rows1['u_fname'];
