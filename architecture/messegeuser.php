...
<?php
 $ghfh="select * from message WHERE l_id=$cl_id AND a_id=$l_id";
 $results = $con->query($ghfh);
    ...
    ">              
                     <?php
                      ...
                      if($rows['u_img']!="") { ?>
                     <span  style="float:left; text-align: right;"><img width="200px" src="../uploads/<?php  echo $u_img= $rows['u_img']; ?>"> </span>
                   <?php } ?> 
                     <span  style="float:right;"><?php  echo $replay= $rows['replay']; ?></span>
    ...
    ">
                    ...
                    <span  style="float:left; text-align: right;"><?php  echo $message= $rows['message']; ?> </span>
                    </div>
                    <div style="    
    justify-content: space-between;
    width: 100%;
    ...
    ">
                     <?php
                      ...
                      if($rows['ur_img']!="") { ?>
                     <span  style="float:right; text-align: right;"><img width="200px" src="../uploads/<?php  echo $ur_img= $rows['ur_img']; ?>"> </span>
...
<?php  }
                 ...
                 <form action="messegesubmit.php" method="POST" enctype="multipart/form-data"> 
...
<input type="hidden" name="l_id" value="<?php echo $l_id; ?>" >
                      ...
                      <input type="file" name="u_file" placeholder="Type Your Doubts" style="border: 0;
    font-size: 0.875rem;
    line-height: 1.3;
    font-weight: 400;
    width: 70%;
    ...
    transition: border 0.15s cubic-bezier(0.165, 0.84, 0.44, 1);">
                       <input type="text" name="a_id" placeholder="Type Your Doubts" style="border: 0;
    font-size: 0.875rem;
    line-height: 1.3;
    font-weight: 400;
    width: 50%;
    ...
    transition: border 0.15s cubic-bezier(0.165, 0.84, 0.44, 1);"><br>
