              ...
              <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  <div class="sectionHeading -left-line">
                    <span class="sectionHeading__subtitle">COMPANY DETAILS</span>
                    <h2 class="sectionHeading__title">COMPANY DETAILS</h2>
                  </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                      ...
                      <?php 
                  $result = $con->query("select * from company_registration WHERE cl_id=$l_id");
                               while($row= mysqli_fetch_array($result))
                                 {
                                 ?>

                     <form class="" action="aprofileupdate.php" method="POST">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="companyname" value="<?php echo $row['c_companyname'];?>" data-required placeholder="Company Name">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" value="<?php echo $row['c_password'];?>" name="password" placeholder="Password">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
