...
if(isset($_POST['submit']))
{
 ...
 if(!$stmt=mysqli_query($con,$sql))
    ...
    $id=mysqli_insert_id($con);
     echo $q="INSERT INTO userregistration(ul_id,u_fname,u_lname,u_address,u_email,u_password,u_phonenumber,u_pincode,u_file)VALUES($id,'$fname','$lname','$address','$email','$password','$phonenumber','$pincode','$filename')";
    //var_dump($q);
