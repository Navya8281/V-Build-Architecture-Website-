            ...
            <div class="menu js-menu ">
              ...
              <div class="menu__container">
                <div class="mobile__back js-nav-list-back pointer-events-none">
                  <a data-barba href="userprofile.php">Users</a>
                </div>
                ...
                <ul class="nav js-navList ">
                  ...
                  <li class="text-white">
                    <a data-barba href="companyprofile.php">Company</a>

                    
                  </li>
                  <li class="text-white">
                    <a data-barba href="realestateprofile.php">Realestate</a>
                  </li>
                  <li class="text-white">
                    <a data-barba href="viewplan.php">Plan</a>
                  </li>
                       <li class="text-white">
...
<!--
                  <li class="text-white">
                    <a data-barba href="blog.php">Blog</a>
