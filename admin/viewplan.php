              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">House Plans</div>
                    <h1 class="page-masthead__title text-white">House Plans</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">House Plans</a>
                  </div>
                </div> -->
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="row y-gap-32 mt-40 lg:mt-20">
                  ...
                  $sql="SELECT *
FROM requirement
INNER JOIN company_booking ON requirement.b_id=company_booking.b_id;";
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="../uploads/<?php echo $row['plan'];?>" alt="Product image">

                         <a href="approveplan.php?rb_id=<?php echo $row['rb_id'];?>&status=<?php echo $row['status'];?>" class="shopCard__button"> 
                      ...
                      <div class="shopCard__content mt-20">
                         ...
                         <h4 class="shopCard__title text-base mt-8"><?php  $bcl_id= $row['bcl_id'];

  
                   $sql1="SELECT * FROM `company_registration` WHERE c_id='$bcl_id'";
