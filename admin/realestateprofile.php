...
-->
                ...
                <?php 
                  $result = $con->query("select * from real_estate_registration");
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="../uploads/<?php echo $row['r_file'];?>" width="200px;" alt="Product image">

                        <a  href="realprofiledetails.php?id=<?php echo $rl_id= $row['rl_id'];?>" class="shopCard__button">
                      ...
                      <div class="shopCard__content mt-20">
                        ...
                        <h4 class="shopCard__title text-base mt-8"><?php echo $row['r_fname'];?></h4>
                        <?php 
                  $result1 = $con->query("select * from login WHERE l_id=$rl_id ");
                               while($row1= mysqli_fetch_array($result1))
                                 {
									 ?>
									 Status : <?php echo $row1['l_approve'];?>
									<?php }
									 ?>
                      </div>
                      <div class="col-12 mt-32">
                       <a href="deleterealestate.php?id=<?php echo $row['rl_id'];?>"> <button type="submit" name="submit" class="button -md -accent text-white">
                          DELETE
                        </button>
						  </a>
                      </div>
