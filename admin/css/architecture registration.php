...
<!-- Mirrored from creativelayers.net/themes/hellix-html/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:14:36 GMT -->
<head>
          ...
          <div class="container">
            <div class="row no-gutters">
              <div class="col-xl-7 col-lg-7 z-1">
                <div id="map" class="map ratio ratio-1:1"></div>
              </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    <span class="sectionHeading__subtitle text-white">COMPANY REGISTRATION FORM</span>
                    <h2 class="sectionHeading__title text-white">REGISTER NOW</h2>

                    <form class="-light row js-ajax-form" action="#" method="POST" action="https://creativelayers.net/themes/hellix-html/contact.php" data-message-success="Your message has been sent! We will reply you as soon as possible." data-message-error="Something went wrong. Please contact me directly at <a href='hellix%40example.html'>hellix@example.com</a>.">
                      
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="companyname" data-required placeholder="Company Name">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" data-required placeholder="Your Email">
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
