              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">USER PROFILE</div>
                    <h1 class="page-masthead__title text-white">USER PROFILE</h1>
                  </div>
                </div>
...
-->
                ...
                <?php 
                  $result = $con->query("select * from userregistration ");
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="../uploads/<?php echo  $row['u_file'];?>" width="200px;" alt="Product image">

                        <a  href="profiledetails.php?id=<?php echo $ul_id = $row['ul_id'];?>" class="shopCard__button">
                      ...
                      <div class="shopCard__content mt-20">
                        ...
                        <h4 class="shopCard__title text-base mt-8">Name : <?php echo $row['u_fname'];?></h4>
                        <?php 
                  $result1 = $con->query("select * from login WHERE l_id=$ul_id ");
                      ...
                      <div class="col-12 mt-32">
                       <a href="deleteuser.php?id=<?php echo $row['ul_id'];?>"> <button type="submit" name="submit" class="button -md -accent text-white">
                          DELETE
                        </button>
						  </a>
                      </div>
