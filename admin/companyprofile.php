...
-->
                ...
                <?php 
                  $result = $con->query("select * from company_registration ");
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="../uploads/<?php echo $row['c_file'];?>" width="200px;" alt="Product image">

                        <a  href="comprofiledetails.php?id=<?php echo$cl_id= $row['cl_id'];?>" class="shopCard__button">
                      ...
                      <div class="shopCard__content mt-20">
                        ...
                        <h4 class="shopCard__title text-base mt-8">Name : <?php echo $row['c_companyname'];?></h4>
                         <?php 
                  $result1 = $con->query("select * from login WHERE l_id=$cl_id ");
                      ...
                      <div class="col-12 mt-32">
                       <a href="deletecompany.php?id=<?php echo $row['cl_id'];?>"> <button type="submit" name="submit" class="button -md -accent text-white">
                          DELETE
                        </button>
						  </a>
                      </div>
