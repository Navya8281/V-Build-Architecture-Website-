      ...
      <div class="content-wrapper  js-content-wrapper">
              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Real Estate PROFILE</div>
                    <h1 class="page-masthead__title text-white">Real Estate PROFILE</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Real Estate Company List</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="layout-pt-lg layout-pb-xl md:pb-64">
          <div class="container">
           ...
           <?php 
                  $result = $con->query("select * from real_estate_registration WHERE rl_id=$id");
                               while($row= mysqli_fetch_array($result))
                                 {
                                 ?>

                    <form class="" action="realestateupdate.php" method="POST">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                         <input type="hidden" name="id" value="<?php echo $row['rl_id'];?>" data-required placeholder="First Name">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="phonenumber" value="<?php echo $row['r_mobilenumber'];?>" placeholder="phone Number">
                           <span class="form__error"></span>
                        </div>
                      </div>
