...
<!-- Mirrored from creativelayers.net/themes/hellix-html/shop-complete.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:13:02 GMT -->
<head>
              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Shop Complete</div>
                    <h1 class="page-masthead__title text-white">Shop Complete</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Shop Complete</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="row no-gutters y-gap-32">
                    <div class="col-md-3 col-sm-6">
                      <div class="shopCompleted-info__item">
                        <div class="subtitle text-grey">Order Number</div>
                        <div class="title text-black">13119</div>
                      </div>
                    </div>

                    <div class="col-md-3 col-sm-6">
                      <div class="shopCompleted-info__item">
                        <div class="subtitle text-grey">Date</div>
                        <div class="title text-black">27/07/2021</div>
                      </div>
                    </div>

                    <div class="col-md-3 col-sm-6">
                      <div class="shopCompleted-info__item">
                        <div class="subtitle text-grey">Total</div>
                        <div class="title text-black">$40.10</div>
                      </div>
                    </div>

                    <div class="col-md-3 col-sm-6">
                      <div class="shopCompleted-info__item">
                        <div class="subtitle text-grey">Payment Method</div>
                        <div class="title text-black">Direct Bank Transfer</div>
                      </div>
                    </div>
                  </div>
                </div>
...
<!-- Mirrored from creativelayers.net/themes/hellix-html/shop-complete.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:13:23 GMT -->
</html>