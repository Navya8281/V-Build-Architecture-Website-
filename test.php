              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Shop Single</div>
                    <h1 class="page-masthead__title text-white">Shop Single</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Shop Single</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="shopSingle-preview__imageList js-slider-pagination">
                    <div data-cursor class="gallery__item">
                      <div class="ratio ratio-62:60">
                        <img class="ratio-img" src="img/shop/products/1.jpg" alt="project image">
                      </div>
                    </div>

                    <div data-cursor class="gallery__item">
                      <div class="ratio ratio-62:60">
                        <img class="ratio-img" src="img/shop/products/2.jpg" alt="project image">
                      </div>
                    </div>

                    <div data-cursor class="gallery__item">
                      <div class="ratio ratio-62:60">
                        <img class="ratio-img" src="img/shop/products/3.jpg" alt="project image">
                      </div>
                    </div>

                    <div data-cursor class="gallery__item">
                      <div class="ratio ratio-62:60">
                        <img class="ratio-img" src="img/shop/products/4.jpg" alt="project image">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="shopSingle-preview__image js-slider-slider">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <a href="img/shop/products/1.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                          <div class="ratio ratio-62:60">
                            <img class="ratio-img" src="img/shop/products/1.jpg" alt="project image">
                          </div>
                      ...
                      <div class="swiper-slide">
                        <a href="img/shop/products/2.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                          <div class="ratio ratio-62:60">
                            <img class="ratio-img" src="img/shop/products/2.jpg" alt="project image">
                          </div>
                      ...
                      <div class="swiper-slide">
                        <a href="img/shop/products/3.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                          <div class="ratio ratio-62:60">
                            <img class="ratio-img" src="img/shop/products/3.jpg" alt="project image">
                          </div>
                      ...
                      <div class="swiper-slide">
                        <a href="img/shop/products/4.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                          <div class="ratio ratio-62:60">
                            <img class="ratio-img" src="img/shop/products/4.jpg" alt="project image">
                          </div>
              ...
              <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  <div class="sectionHeading -left-line">
                    ...
                    <h2 class="sectionHeading__title"><?php echo $row['c_companyname'];?></h2>
                  </div>

                  <div class="text-sm text-black leading-4xl mt-48 md:mt-16">
                    <p>PHONE NUMBER: <?php echo $row['c_phonenumber'];?></p>
                  ...
                  <div class="socialsSection mt-24">
                   <div class="col-auto">
                    <form action="booking_form.php" method="post">
                      <input type="text" name="booking_id" value="<?php echo $row['c_id'];?>">
