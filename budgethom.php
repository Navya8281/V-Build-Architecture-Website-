...
?>
              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Budgeted Homes</div>
                    <h1 class="page-masthead__title text-white">Budgeted Homes</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Budgeted Homes</a>
                  </div>
                </div> -->
              </div>
            </div>
 ...
 -->
                <div class="row y-gap-32 mt-40 lg:mt-20">
                  <?php 
                  $result = $con->query("select * from budgeted_home");
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="shopCard text-center">
                      <div class="shopCard__image ratio ratio-29:33">
                        <img class="ratio-img" src="uploads/<?php echo $row['bu_image'];?>" alt="Product image">

                        <a href="homcompg.php?bu_id=<?php echo $row['bu_id'];?>&cccid=<?php echo $row['cl_id'];?>" class="shopCard__button">
                          <i class="icon" data-feather="shopping-bag"></i>
                          <?php  $cl_id=$row['cl_id'];
                          $result1 = $con->query("select *from company_registration WHERE cl_id=$cl_id");
                      ...
                      <div class="shopCard__content mt-20">
                        <?php echo $row['bu_description'];?><br>
                       <?php echo $row['bu_budget'];?> <br>
                       <?php echo $row['bu_sqft'];?> <br>
