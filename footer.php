                ...
                <div class="col-lg-3 col-md-6">
                  <div class="footer__item">
                    ...
                    <div class="footer__content">
                      <div class="footer__content__item">
                        <!-- <a data-barba href="architecturecompany.php">Architecture companies</a> -->
                      </div>

                      <div class="footer__content__item">
                        <!-- <a data-barba href="user/land_view.php">Lands For Sale</a> -->
                      </div>
            ...
            <div class="container">
              <div class="row align-items-center justify-content-between sm:justify-content-start">
                <div class="col-auto sm:order-2">
                  <div class="footer__bottom_text">V-Build</div>
                </div>
                ...
                <div class="col-auto sm:d-none">
                  <div class="footer__bottom_text">Designed by V-Build</div>
                </div>
              </div>
            </div>
          </div>
