...
include('database.php');
 $bu_id=$_GET['bu_id'];
 $result = $con->query("select * from budgeted_home WHERE bu_id=$bu_id");
              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">Company Profile</div>
                    <h1 class="page-masthead__title text-white">Company Profile</h1>
                  </div>
                </div>
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">Company Profile</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-7">
                <div class="shopSingle-preview js-shop-slider">
                  <div class="shopSingle-preview__imageList js-slider-pagination">
                    <?php 
                  $result1 = $con->query("select * from gallery WHERE a_id=$cccid");
                               while($row1= mysqli_fetch_array($result1))
                                 {
                                 ?>
                    <div data-cursor class="gallery__item">
                      <div class="ratio ratio-62:60">
                        <img class="ratio-img" src="uploads/<?php echo $row1['image'];?>" alt="project image">
                      </div>
                    </div>
<?php } ?> 
...
<?php 
                  $result2 = $con->query("select * from gallery WHERE a_id=$cccid");
                               while($row2= mysqli_fetch_array($result2))
                                 {
                                 ?>
                      <div class="swiper-slide">
                        <a href="uploads/<?php echo $row2['image'];?>" class="gallery__item js-gallery" data-gallery="gallery1">
                          <div class="ratio ratio-62:60">
                            <img class="ratio-img" src="uploads/<?php echo $row2['image'];?>" alt="project image">
                          </div>
...
<?php } ?> 
               ...
               <?php 
                  $result = $con->query("select * from company_registration WHERE cl_id=$cl_id");
                               while($row= mysqli_fetch_array($result))
                                 {
                                 ?>
              <div class="col-xl-4 col-lg-4 offset-lg-1">
                <div class="md:pt-40 md:pb-40">
                  ...
                  <div class="text-sm text-black leading-4xl mt-48 md:mt-16">
                    <b><i><p>PHONE NUMBER:</b></i> <?php echo $row['c_phonenumber'];?></p>
                    <b><i><p>ADDRESS:</i></b> <?php echo $row['c_address'];?></p>
                    <b><i><p>EMAIL:</i></b> <?php echo $row['c_email'];?></p>
                  ...
                  <div class="socialsSection mt-24">
                   <div class="col-auto">
                    <form action="budget_bookingg.php" method="post">
