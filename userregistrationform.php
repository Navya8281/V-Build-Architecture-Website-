              ...
              <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                  <div data-anim="slide-up delay-1">
                    ...
                    <div class="page-masthead__back_title">USER REGISTRATION</div>
                    <h1 class="page-masthead__title text-white">User Registration</h1>
                  </div>
                </div>
                ...
                <!-- <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                    ...
                    /
                    <a data-barba href="#" class="page-masthead-bread__item ">User Registration</a>
                  </div>
                </div> -->
              </div>
            </div>
              ...
              <div class="col-xl-7 col-lg-7 offset-lg-5 z-5">
                <div class="mt-minus-xl md:mt-0">
                  <div class="sectionHeading -left-line bg-dark py-48 px-48 md:py-20 md:px-20">
                    ...
                    <form  action="useraction1.php" method="POST" enctype="multipart/form-data">
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="fname" pattern="[A-Za-z]{2,50}" data-required placeholder="First Name" required>
                          <span class="form__error"></span>
                        </div>
                      </div>
                       <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="lname" pattern="[A-Za-z]{2,50}" data-required placeholder="Last Name"required>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12">
                      ...
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="email" name="email" data-required placeholder=" Email" required>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Password" required>
                          <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="phonenumber" pattern="[0-9]{10}"   maxlength="10" minlength="10" placeholder="phone Number" required>
                           <span class="form__error"></span>
                        </div>
                      </div>
                      <div class="col-12 mt-20">
                        <div class="js-input-group">
                          <input type="text" name="pincode" pattern="[0-9]{6}"pattern="[0-9]{6}"   maxlength="6" minlength="6" placeholder="Pincode" required>
                           <span class="form__error"></span>
                        </div>
                      </div>
                       <div class="col-12 mt-20">
