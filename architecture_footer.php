<footer class="footer -type-1 -light bg-white">
              ...
              <div class="row y-gap-48 justify-content-between">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="footer__item">
                    <h3 class="footer__title text-black">Contact</h3>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="footer__item">
                    <h3 class="footer__title text-black">OUR SERVICES</h3>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="footer__item">
                    <h3 class="footer__title text-black">USEFUL LINKS</h3>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="footer__item">
                    <h3 class="footer__title text-black">SUBSCRIBE</h3>
                    ...
                    <div class="footer__content">
                      ...
                      <div class="footer__socials">
                        <h3 class="footer__title text-black">FOLLOW US</h3>
...
<!-- Mirrored from creativelayers.net/themes/hellix-html/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 11:13:59 GMT -->
</html>